...
int main(){
    ...
    std::cout<< "generate room1(already exist): " <<rc.generateRoom(1, "room1")<<"\n";
    ...
    std::cout<< "add character 4(already exist) to room1: " << rc.addCharacterToRoom(4,1) << "\n";
    ...
    std::cout<< "remove character 9(non exist) from room1: " << rc.removeCharacterFromRoom(9,1) << "\n";
    std::cout<< "remove character 10 from room2: " << rc.removeCharacterFromRoom(10,2) << "\n";
    std::cout<< "remove character 10 from room18(non exist): " << rc.removeCharacterFromRoom(10,18) << "\n";
    ...
    std::cout << rc.getRoomDescription(1000) << std::endl;
